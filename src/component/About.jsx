    ...
    return (
        <div id="about" className="lg:ml-32 lg:p-28 lg:flex lg:justify-center relative lg:gap-14" >
            ...
            <div className="mt-7 text-center lg:mt-0 lg:text-left space-y-3">
                ...
                <p className='lg:w-[70%] p-4 text-center'>As a Junior Front-End Developer, I possess an impressive arsenal of skills in HTML, CSS, JavaScript, React.js, Tailwind, Express.js Mongodb, Firebase, JWT. I excel in designing and maintaining responsive websites that offer a smooth user experience. My expertise lies in crafting dynamic, engaging interfaces through writing clean and optimized code and utilizing cutting-edge development tools and techniques. I am also a team player who thrives in collaborating with cross-functional teams to produce outstanding web applications.</p>
            </div>
