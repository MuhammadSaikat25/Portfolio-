...
const Building = () => {
  return (
    <div className="max-w-7xl mx-auto w-full">
      <div className="flex flex-col lg:flex-row gap-5 mx-auto  shadow-lg rounded-xl bg-[#F6ECA9] p-4 mb-10">
        <img
        ...
        <div className="w-fit  h-full p-4 ">
          ...
          <p className="text-center h-full text-sm mt-5 lg:text-base text-gray-700 font-medium">
            ...
            and a member dashboard . A user can register, can request for
            booking a apartment . Admins have additional privileges, manage
            member, manage booking request, when admin accept any booking
            request, then user's role will be member and admin reject request
            then user's role still be user ,And when admin accept any request
            then member can access the member dashboard.Admin can make
            announcement. A member can payment for her apartment, He can see her
            all payment history, and can also see all announcement has admin
            make. It showcases my skills in front-end development, Firebase
          ...
          <div className="grid lg:grid-cols-4 grid-cols-2 mx-auto gap-4 mt-4 text-center">
            <h1 className=" bg-gray-50 shadow-md rounded-full py-2 px-10">React.js</h1>
            ...
            <h1 className=" bg-gray-50 shadow-md rounded-full py-2 px-10">Mongodb</h1>
          </div>
          {/* ------------------------ */}
